...
- **Attacks**: This feature, when enabled, stops web-based attacks before they reach the web server. It is based on[ModSecurity](https://modsecurity.org/) and can be configured to various intense degrees.
