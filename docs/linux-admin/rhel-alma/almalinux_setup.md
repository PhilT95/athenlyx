...
5. Make sure the Setting **PermitRootLogin** within the ssh configuration files in the directory `/etc/ssh/` is set to **No**. The file is called `sshd_config` per default
