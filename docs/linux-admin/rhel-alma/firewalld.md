...
|`--permanent`|Adds a rule to the permanent rule set. Otherwise the rule is lost after the next configuration reload.|`firewall-cmd --add-service=http --zone=public --internal`|
